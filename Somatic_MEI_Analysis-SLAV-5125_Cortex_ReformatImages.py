...
SC_5125_Cortex_Train = sys.argv[1]

Data_Sets_Train = []
Data_Sets_Train.append([SC_5125_Cortex_Train,Bulk_5125_Cortex,Bulk_5125_Liver])
...
for dset in Data_Sets_Train:
    ...
    for file in glob.glob("*sml*.png"):
        if "mod" not in file or "blk" not in file or "cropped" not in file:
