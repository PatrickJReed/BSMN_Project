...
checkpoint = ModelCheckpoint("slav_incv3_scratch2.h5", monitor='loss', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
early = EarlyStopping(monitor='loss', patience=10, verbose=1, mode='auto')
csv_logger = CSVLogger('training_scratch2.log', append=True, separator=';')
tensorboard = TensorBoard(log_dir='./logs', histogram_freq=0,
                          write_graph=True, write_images=False)

model = load_model('slav_incv3_scratch.h5')
        ...
        for cell in dset[0]:
            ...
            if os.path.isfile(os.path.join(basepath, cell, cell+'_XY.npz')):
                try:
                    ...
                    print("npz is bad")
                    pass
model.save('inceptionV3_SLAV_Scratch2.h5')  